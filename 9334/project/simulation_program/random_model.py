...
def random_model(arrival,service,network,para):
    ...
    def ran_arrival(lam):# get random arrival_time
    ...
    totalNumberOfJobsCompleted=0 #completed jos when dep
    ...
    #speated with netand without net,build service at cloud
    ...
    while master_clock < time_end:
        ...
        if event ==1:#dep from fog without cloud 
            ...
            event_list[1]=next_dep_fog_woC
            event_list[2]=next_dep_fog_wC
            totalNumberOfJobsCompleted=totalNumberOfJobsCompleted+1 #completed number
